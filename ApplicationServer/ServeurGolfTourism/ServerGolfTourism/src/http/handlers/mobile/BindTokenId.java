...
public class BindTokenId extends CustomizedHandler {
	 ...
	 * \return void
	 * \brief Handles a "new incoming user" request by generating a token, inserting it into the general set of users and giving it back to the client for later use.
	 * */
	@Override
